...
public class IntegerEditor extends JTextField implements TableCellEditor, NumberEditor {
  ...
  public IntegerEditor(JInternalFrame topWindow) {
    this(topWindow, false);
  }
  
  public IntegerEditor(JInternalFrame topWindow, boolean blanksOK) {
  ...
  public static void triggerWarning(JInternalFrame top) {
