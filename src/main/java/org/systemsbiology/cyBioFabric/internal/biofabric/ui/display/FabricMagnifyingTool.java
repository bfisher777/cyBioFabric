...
import org.systemsbiology.cyBioFabric.internal.biofabric.util.ColorListRenderer;
...
public class FabricMagnifyingTool extends JPanel {
  ...
  */
  ...
  public FabricMagnifyingTool(FabricColorGenerator colGen) {
    ...
    toLock_ = new JLabel("Lock: L", JLabel.CENTER);
  ...
  */
  ...
  public void keyInstall(JPanel cpane) {
    ...
    iMapw.put(KeyStroke.getKeyStroke(KeyEvent.VK_L, 0), "MagnifyFreeze");//TODO changed   
    ...
    aMap.put("MagnifyFreeze", new AbstractAction() {
      ...
      public void actionPerformed(ActionEvent e) {
        try {
          ...
          toLock_.setText((ignore_) ? "Unlock: L" : "Lock: L");
          toLock_.invalidate();
          lockPanel_.validate();
  ...
  */
  ...
  public Dimension getMinimumSize() {
    if (neverSet_) {
      return (new Dimension(550, (2 * (FabricMagnifier.PREF_SIZE * FabricMagnifier.MAG_GRID))));//TODO changed this from 550 and 2X
    } else {
      return (new Dimension(550, (2 * (FabricMagnifier.MIN_SIZE * FabricMagnifier.MAG_GRID))));//TODO changed this from 550 and 2X
    }
  }
  
  @Override
  public Dimension getMaximumSize() {
    return (new Dimension(4000, (2 * (FabricMagnifier.MAX_SIZE * FabricMagnifier.MAG_GRID)) + 40));//TODO changed this from 2X    
  }
