...
public class UniqueLabeller implements Cloneable {
  ...
  private TreeSet<Comparable> existing_;
  private HashSet<String> legacy_;
  ...
  */
  ...
  public UniqueLabeller() {
    existing_ = new TreeSet<Comparable>(new KeyComparator());
    legacy_ = new HashSet<String>();
    isNumeric_ = true;
    fixedPrefix_ = null;
  }
  ...
  */
  ...
  public UniqueLabeller(UniqueLabeller other) {
    this.existing_ = (TreeSet<Comparable>)other.existing_.clone(); // Immutable contents; shallow OK
    this.isNumeric_ = other.isNumeric_;
    this.fixedPrefix_ = other.fixedPrefix_;
    this.legacy_ = (HashSet<String>)other.legacy_.clone(); // Immutable contents; shallow OK
  }  
  ...
  */
  ...
  public Object clone() {
    try {
      ...
      retval.existing_ = (TreeSet<Comparable>)this.existing_.clone(); // Contents are immutable; shallow OK
      if (!(retval.existing_.comparator() instanceof KeyComparator)) {
        throw new IllegalStateException();
      }
      retval.legacy_ = (HashSet<String>)this.legacy_.clone(); // Contents are immutable; shallow OK
      return (retval);
  ...
  */
  ...
  private void convertToAlpha() {
    ...
    TreeSet<Comparable> newSet = new TreeSet<Comparable>(new KeyComparator());
    Iterator<Comparable> eit = existing_.iterator();
    while (eit.hasNext()) {
