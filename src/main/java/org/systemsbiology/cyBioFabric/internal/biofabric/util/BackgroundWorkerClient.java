...
public class BackgroundWorkerClient {
  ...
  public BackgroundWorkerClient(BackgroundWorkerOwner owner, BackgroundWorker worker, 
                                JInternalFrame topWindow, BackgroundWorkerControlManager suw, String waitTitle, 
  ...
  private void prepProgressDialog() {
    ...
    if (allowCancels_) {
      progressDialog_.setDefaultCloseOperation(JInternalFrame.DO_NOTHING_ON_CLOSE);
