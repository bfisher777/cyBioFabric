...
public class ImportWithNodeAttributes extends AbstractCyAction implements BioFabricImageIcon{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 5777347330507449531L;
	...
	public void actionPerformed(ActionEvent e) {		
	    ...
	    fc.getAction(CommandSet.LOAD_WITH_NODE_ATTRIBUTES, false, null).actionPerformed(null);		
	}
