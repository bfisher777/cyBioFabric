...
public class ToolsCompareMultipleNodes extends AbstractCyAction implements BioFabricImageIcon{
	
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -6226547794350863526L;
	private String COMMAND_SET_NAME;	
	
	public ToolsCompareMultipleNodes(Map<String, String> configProps,  CyApplicationManager applicationManager, 
	...
	public void actionPerformed(ActionEvent e) {		
	    ...
	    fc.getAction(CommandSet.COMPARE_NODES, false, null).actionPerformed(null);		
	}
