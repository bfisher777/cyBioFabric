...
import com.boofisher.app.cySimpleRenderer.internal.CyActivator;
...
public class AboutDialog extends JDialog {
	...
	public AboutDialog(CySwingApplication application, OpenBrowser openBrowser) {
		super(application.getJFrame(), "About CySR", ModalityType.MODELESS);
		...
		editorPane
				.setText("<html><body>"
						...
						+ "</tr></table>"
						+ "<p align=center>"
						+ "Simple Network Renderer for Cytoscape."
						+ "<BR><BR>"
						+ "by Ben Fisher<BR>"
