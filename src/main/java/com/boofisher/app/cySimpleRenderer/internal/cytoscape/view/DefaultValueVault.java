...
import com.boofisher.app.cySimpleRenderer.internal.cytoscape.view.VisualPropertyValue;
...
public class DefaultValueVault {// Assumes VisualProperty ID names are unique
