...
package com.boofisher.app.cyBioFabric.internal.biofabric.model;
...
import com.boofisher.app.cyBioFabric.internal.biofabric.analysis.Link;
...
import com.boofisher.app.cyBioFabric.internal.biofabric.util.CharacterEntityMapper;
import com.boofisher.app.cyBioFabric.internal.biofabric.util.DataUtil;
...
public class MasterBioFabricNetwork {
  ...
  public TreeMap fullLinkDefs_;
  public TreeMap nonShadowedLinkMap_;
  public HashMap nodeDefs_;
  
  //
  // Grouping for links:
  //
  
  public List linkGrouping_;
  ...
  */
  ...
  public MasterBioFabricNetwork(BuildData bd) {
    int mode = bd.getMode();
    ...
    switch (mode) {
      ...
      case SHADOW_LINK_CHANGE:
        MasterBioFabricNetwork built = ((PreBuiltBuildData)bd).bfn;
  ...
  */
  ...
  private void processLinks(Set allLinks, Set loneNodes, FabricColorGenerator colGen) {    
    ...
    for(String tar: (List<String>)targets){
    	lines.add(tar);
    }
    
    Path file = Paths.get("C:\\Users\\Ben\\Desktop\\BioFabric100\\masterDefaultNodeOrderDump.txt");
  ...
  */
  ...
  private List pruneToMinSubModel(MasterBioFabricNetwork bfn, List targetList, List linkList) {
  ...
  */
  ...
  private void fillSubModel(MasterBioFabricNetwork bfn, List targetList, List linkList) {
    ...
    while (cit.hasNext()) {
      MasterBioFabricNetwork.LinkInfo linf = (MasterBioFabricNetwork.LinkInfo)cit.next();
      ...
      MasterBioFabricNetwork.LinkInfo miniLinf = new MasterBioFabricNetwork.LinkInfo(linf.getLink(), startRowObj.intValue(), endRowObj.intValue(), 
    ...
    while (tgit.hasNext()) {
      MasterBioFabricNetwork.NodeInfo infoFull = (MasterBioFabricNetwork.NodeInfo)tgit.next();
      Integer miniRowObj = (Integer)rowMap.get(new Integer(infoFull.nodeRow));
      MasterBioFabricNetwork.NodeInfo infoMini = new MasterBioFabricNetwork.NodeInfo(infoFull.nodeName, miniRowObj.intValue(), infoFull.colorKey);
    ...
    for (int i = 0; i < rowCount_; i++) {
      MasterBioFabricNetwork.NodeInfo infoMini = (MasterBioFabricNetwork.NodeInfo)modTargetList.get(i);
    ...
    for (int i = 0; i < numMll; i++) {
      MasterBioFabricNetwork.LinkInfo infoMini = (MasterBioFabricNetwork.LinkInfo)modLinkList.get(i);
  ...
  */  
  ...
  public static class PreBuiltBuildData extends BuildData {
    MasterBioFabricNetwork bfn;
  
    public PreBuiltBuildData(MasterBioFabricNetwork bfn, int mode) {
      super(mode);
      this.bfn = bfn;
    } 
  }
  ...
  */  
  ...
  public static class RelayoutBuildData extends BuildData {
    ...
    public RelayoutBuildData(MasterBioFabricNetwork fullNet, int mode) {
      super(mode);
      this.bfn = fullNet;
  ...
  */  
  ...
  public static class SelectBuildData extends BuildData {
     MasterBioFabricNetwork fullNet;
     List subNodes;
     List subLinks;

    public SelectBuildData(MasterBioFabricNetwork fullNet, List subNodes, List subLinks) {
  ...
  */  
  ...
  public static class ColumnAssign  {
    public HashMap columnToSource;
    public HashMap columnToTarget;
