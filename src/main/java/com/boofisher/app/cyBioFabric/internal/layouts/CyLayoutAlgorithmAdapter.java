...
/**
 * Wrapper for cytoscape layout algorithms that support BF, activates the tunable
 * property that puts the layout into BF mode.
 * 
 * @author mkucera
 */
public class CyLayoutAlgorithmAdapter implements CyLayoutAlgorithm {
	
	private static final String LAYOUT_BF_PROPERTY = "layoutBioFabric";
	...
	public Object createLayoutContext() {
		...
		tunableValues.put(LAYOUT_BF_PROPERTY, true);
