...
import com.boofisher.app.cyBioFabric.internal.biofabric.io.AttributeLoader.AttributeKey;
import com.boofisher.app.cyBioFabric.internal.biofabric.layouts.WordLinkComm.GroupRange;
...
public class WordLinkComm {
  ...
  */
  ...
  public Set<Link> readEdgeTab(File infile) throws IOException {
    //
    // Read in the lines.
    //    
    
    BufferedReader in = null;
    HashSet<Link> interact = new HashSet<Link>();
  ...
  */
  ...
  public SortedMap<Integer, HashSet<FabricLink>> readCSV(File infile, List<FabricLink> allLinks, Map<?, ?> nodeOrder, SortedSet<GroupRange> groupOrder, Set<?> trueLinks) throws IOException {

    TreeMap<Integer, HashSet<FabricLink>> retval = new TreeMap<Integer, HashSet<FabricLink>>();
    ArrayList<GroupRange> groups = new ArrayList<GroupRange>();
    BufferedReader in = null;
    int lineNum = 0;
    try {
      in = new BufferedReader(new FileReader(infile));
      ...
      while ((line = in.readLine()) != null) {
        ...
        List<String> tokens = processCSVLine(line);
        if (tokens.isEmpty()) {
          continue;
        }
        ...
        HashSet<FabricLink> links = (HashSet<FabricLink>)retval.get(comName);
        if (links == null) {
          links = new HashSet<FabricLink>();
  ...
  */
  ...
  private List<String> processCSVLine(String line) {
  ...
  */
  ...
  public Map<AttributeKey, String> readEdgeOrder(File file) throws IOException {
  ...
  */
  ...
  public Map<AttributeKey, String> readNodeOrder(File file) throws IOException {
    HashMap<AttributeKey, String> attributes = new HashMap<AttributeKey, String>();   
    AttributeLoader.ReadStats stats = new AttributeLoader.ReadStats();
    AttributeLoader alod = new AttributeLoader();
  ...
  */
  ...
  public static class GroupRangeComparator implements Comparator<Object> {
